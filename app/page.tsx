...
export default function Base() {
  ...
  }, [user?.balance, user?.firstName, user?.tg_id, user?.authDate])
      ...
      <div className="infos w-full">
        <div className="dt w-full">
          ...
          <div className="mt-2 px-[10px] py-[5px] border border-[#2d2d2d] flex flex-col gap-2">
            ...
            <div className="flex justify-between">
              <div>Squad:</div>
              <div className="text-[#959595]">{user?.friends}</div>
            </div>
            <div className="flex justify-between">
              <div>Date joined:</div>
        ...
        <div className="dt w-full">
          <div className="ml-[10px] mb-[5px] mt-[30px] text-[#959595]">Latest war results</div>
          <div className="px-[10px] py-[5px] text-center border border-[#2d2d2d] flex flex-col gap-2">
            <div>Something&apos;s gonna be in here, but not yet.</div>
          </div>
        </div>
      </div>
      <div id="farm">
